  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF6582AE), // Accent color for AppBar
      ),
      body: Center(
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: ConstrainedBox(
              ...
              child: Card(
                color: const Color(0xFF7FA1C4), // Light blue background for the card
                elevation: 8.0,
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Name',
                          filled: true,
                          fillColor: const Color(0xFFE2DAD7), // Light background color
                          enabledBorder: OutlineInputBorder(
                            borderSide: const BorderSide(color: Colors.transparent),
                            borderRadius: BorderRadius.circular(10),
                          ),
                          focusedBorder: OutlineInputBorder(
                            borderSide: const BorderSide(color: Color(0xFF6582AE)), // Accent color
                            borderRadius: BorderRadius.circular(10),
                          ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFF6582AE), // Accent color for the button
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(15),
                            ),
                          ),
